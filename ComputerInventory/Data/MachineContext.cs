...
namespace ComputerInventory.Data
{
    class MachineContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=ServerName;Database=BegEFCore2;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Machine>(entity => {
                ...
                .IsRequired()
                .HasMaxLength(25)
                .IsUnicode(false);//HAce al campo varchar en lugar de nvarchar
                ...
                .WithMany(p => p.Machine) //Crea relación N > 1 Muchas maqunas pueden ser un tipo de maquina
...
.IsUnicode(false);
            ...
            modelBuilder.Entity<SupportLog>(entity => {
                ...
                .IsRequired()
                .HasMaxLength(50)
                .IsUnicode(false); entity.Property(e => e.SupportTicketId).HasColumnName
 ("SupportTicketID");
            ...
            modelBuilder.Entity<SupportTicket>(entity => {
                ...
                ("SupportTicketID");
                entity.Property(e => e.DateReported).HasColumnType("date");//Establece el tipo de datoen DB
